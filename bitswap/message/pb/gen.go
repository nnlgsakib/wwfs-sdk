...
//
//go:generate mkdir -p github.com/nnlgsakib/wwfs-sdk/bitswap/message/pb
//go:generate ln -f message.proto github.com/nnlgsakib/wwfs-sdk/bitswap/message/pb
//go:generate protoc --go_out=. github.com/nnlgsakib/wwfs-sdk/bitswap/message//pb/message.proto
//go:generate mv -f github.com/nnlgsakib/wwfs-sdk/bitswap/message//pb/message.pb.go .
