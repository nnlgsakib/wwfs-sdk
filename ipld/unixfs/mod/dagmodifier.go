...
import (
	...
	help "github.com/nnlgsakib/wwfs-sdk/ipld/unixfs/importer/helpers"
	trickle "github.com/nnlgsakib/wwfs-sdk/ipld/unixfs/importer/trickle"
...
func (dm *DagModifier) modifyDag(n ipld.Node, offset uint64) (cid.Cid, error) {
	...
	if len(n.Links()) == 0 {
		...
		case *mdag.RawNode:
			...
			// See: https://github.com/nnlgsakib/wwfs-sdk/security/code-scanning/7
